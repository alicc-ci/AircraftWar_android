...
public class ImageManager {
    ...
    public static BufferedImage SUPERBULLET_PROP_IMAGE;

    static {
        try {

            BACKGROUND_IMAGE = ImageIO.read(new FileInputStream("src/images/bg.jpg"));
            SIMPLE_BACKGROUND_IMAGE = ImageIO.read(new FileInputStream("src/images/bg2.jpg"));
            NORMAL_BACKGROUND_IMAGE = ImageIO.read(new FileInputStream("src/images/bg3.jpg"));
            HARD_BACKGROUND_IMAGE = ImageIO.read(new FileInputStream("src/images/bg4.jpg"));
            ...
            SUPERBULLET_PROP_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_superbullet.png"));
